...
die 'missing arguments: trace_file_name cpus_number' unless defined $cpus_number;
...
$schedule_backfilling->save_svg("run_from_file-$cpus_number-backfilling.svg");
...
$schedule_backfilling_contiguous->save_svg("run_from_file-$cpus_number-backfilling_contiguous.svg");
